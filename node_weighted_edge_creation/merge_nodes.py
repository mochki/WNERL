...
all_nodes = Counter()
all_nodes.update(c_nodes_01)
all_nodes.update(c_nodes_02)
all_nodes.update(c_nodes_03)
all_nodes.update(c_nodes_04)
all_nodes.update(c_nodes_05)
all_nodes.update(c_nodes_06)
all_nodes.update(c_nodes_07)
all_nodes.update(c_nodes_08)
all_nodes.update(c_nodes_09)
all_nodes.update(c_nodes_10)
all_nodes.update(c_nodes_11)
...
with open('weighted_nodes.pickle', 'wb') as handle:
